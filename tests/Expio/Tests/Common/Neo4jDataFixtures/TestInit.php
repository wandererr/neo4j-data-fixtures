...
$classLoader = new ClassLoader('Doctrine\\Common\\Neo4jDataFixtures', __DIR__.'/../../../../../lib');
$classLoader->register();

$classLoader = new ClassLoader('Doctrine\\Tests\\Common\\Neo4jDataFixtures', __DIR__.'/../../../../../tests');
$classLoader->register();
