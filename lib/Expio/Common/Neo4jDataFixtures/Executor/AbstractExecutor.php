...
abstract class AbstractExecutor
{
     ...
     *
     * @param HireVoice\Neo4j\EntityManager $manager
     */
    ...
    {
        if ($this->purger === null) {
            throw new \Exception('Doctrine\Common\Neo4jDataFixtures\Purger\PurgerInterface instance is required if you want to purge the database before loading your data fixtures.');
        }
        if ($this->logger) {
